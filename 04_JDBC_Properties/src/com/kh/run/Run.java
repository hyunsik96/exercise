...
public class Run {
	...
	public static void main(String[] args) {
		...
		// Properties 는 주로 외부 외부 설정파일을 읽어오는  또는 파일 형태로 값을 출력하고자 하는 목적으로 사용한다.
		// => 파일 입출력 기능을 제공하기 때문에 key 랑 value 모두 문자열 형태로 작성해야 한다.
		...
		// Properties 의 경우 문자열 형태로 키 밸류를 넣을 수 있게끔 제공하는 setProperty("키", "밸류") 메소드
