...
public class MemberController {
	...
	public void insertMember(
		...
		// 2) Dao 의 메소드 호출 (이 때, 위에서 가공된 Member 객체를 매개변수로 넘기겠다)
	...
	public void updateMember(String userId, String newPwd, String newEmail, 
		...
		// 2) DAO 의 메소드 호출 (가공한 VO 를 매개변수로 넘길 예정)
		int result = new MemberDao().updateMember(m); // UPDATE 구문 실행 예정 => int (처리된 행의 갯수)
	...
	public void deleteMember(String userId) {
		...
		// 2) DAO 메소드 호출
		int result = new MemberDao().deleteMember(userId); // DELETE 실행 예정 => int (처리된 행의 갯수)
